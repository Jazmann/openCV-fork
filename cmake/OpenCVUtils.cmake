...
macro(CHECK_MODULE module_name define)
  ...
  if(PKG_CONFIG_FOUND)
    ...
    set(ALIAS_INCLUDE_DIR    ${ALIAS}_INCLUDE_DIR)
    set(ALIAS_LIBRARY_DIRS   ${ALIAS}_LIBRARY_DIRS)
    set(ALIAS_LIBRARY_DIR    ${ALIAS}_LIBRARY_DIR)
    set(ALIAS_LIBRARIES      ${ALIAS}_LIBRARIES)
    PKG_CHECK_MODULES(${ALIAS} ${module_name})
    if(${ALIAS_FOUND})
      find_path(${ALIAS_INCLUDE_DIR} ${module_name} HINTS ${${ALIAS_INCLUDE_DIRS}})
      find_library(${ALIAS_LIBRARY_DIR} ${module_name} HINTS ${${ALIAS_LIBRARY_DIRS}})
      set(${define} 1)
      ...
      find_path(${ALIAS_INCLUDE_DIR} ${module_name} )
      find_library(${ALIAS_LIBRARY_DIR} ${module_name} )
    endif()
  endif()
endmacro()
